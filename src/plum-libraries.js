export const plum_libraries = {
  '[lib]: Import hamburgers module (lib) from plum': {
    prefix: 'plum-import-lib-burgers',
    body: ["@import 'plum-lib-burgers';"],
    description: '[lib]: Import hamburgers module (lib) from plum',
  },

  '[lib]: Import magic module (lib) from plum': {
    prefix: 'plum-import-lib-magic',
    body: ["@import 'plum-lib-magic';"],
    description: '[lib]: Import magic module (lib) from plum',
  },

  '[lib]: Mixin loaders from plum': {
    prefix: 'plum-lib-loaders*1 [4-5-7-8-10-11]',
    body: ['@include loader-${1:index}($$primary: ${2:color});'],
    description: '[lib]: Mixin loaders from plum',
  },
  ...
  '[lib]: Import module loaders (lib) from plum': {
    prefix: 'plum-import-lib-loaders',
    body: ["@import 'plum-lib-loaders';"],
    description: '[lib]: Import module loaders (lib) from plum',
  },

  '[lib]: Mixin magic (animation) from plum': {
    prefix: 'plum-lib-magic-btn',
    body: ['@include magic-btn($$duration: ${1: second});'],
    description: '[lib]: Mixin magic (animation) from plum',
  },
